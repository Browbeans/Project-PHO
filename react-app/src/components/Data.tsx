    ...
    bars: [
      {
        ...
        lng: 11.9727,
        info:
          "Yaki-Da har många ansikten och skepnader. Här finns en terrass, två dansgolv och en prisbelönt kaffebar, utspritt över flera våningar. Högst upp ligger den ekologiska och KRAV-märkta bistron belägen bland takåsarna.",
      },
      {
        title: "Lounge",
        image: "",
        ...
        info:
          "Med flera år på nacken är Lounge(s) en av Avenyns mest etablerade nattklubbar. På flera våningar finns allt som behövs för en lyckad utekväll som barer, dansgolv, roulette och en populär takterass.",
      },
      {
        title: "Hardrock-cafe",
        image: "",
      ...
      },
      {
        ...
        info:
          "Valands nattklubb är sin egen värld, vackert inramad av storslagna konstverk, glittrande kristallkronor och – party! På våningsplanet finns en ambitiös restaurangdel, flertalet barer, dansgolv och scener. Nöjesupplevelsen börjar med afterwork och fortsätter till sena natten.",
      },
    ],
  },
  {
    ...
    bars: [
      {
        ...
        lng: 11.94946,
        info:
          "På Ölstugan 1892 Tullen Hisingen kan ni bland annat äta Pub, Gastropub. Om ni är sugen på detta föreslår vi dig att boka ett bord och kolla på menyn. Tyvärr är det inte möjligt att boka ett bord online. Nå dem på e-post eller telefon för bordsbokning. Ni kan ringa på +4631165616.",
      },
      {
        ...
        info:
          "Gatumat, och det är ganska exakt vad det är! Enkelt & gott, opretentiöst men med krav på kvalité och viljan att vara gatusmart kombinerad med en inbjudande attityd! Det som binder oss samman är kärleken till maten, kvalitén i råvarorna och människorna som äter den! Bärs i mängder",
      },
      {
        title: "Antibarbarus",
        image: "",
    ...
    bars: [
      {
        ...
        info:
          "På SoHO Beer House erbjuder dem mat som . Ifall det är något som är frestande föreslår vi att ni gör en bokning på den här restaurangen och provar. Restaurangen erbjuder inte online-bordsbeställning. Vi föreslår att ni skickar ett e-post eller ringer för bordsbokning.",
      },
      {
        title: "Brygghuset",
        image: "",
        ...
        info:
          "Hans får en ide, han måste givetvis föra sitt arv vidare, det vill säga brygga öl! Han kommer över en nedgången lokal vid järntorget som han renoverar upp tillsammans med Kristina och startar så småningom Göteborgs första bryggeri. De döper bryggeriet till Jerntorgets Brygghus!",
      },
      {
        title: "Cafe-publik",
        image: "",
